        ...
        <div className="flex items-center space-x-7">
            ...
            <div className="space-y-3">
                <div className="w-full">
                    <h1 className="text-sm sm:text-lg lg:text-2xl font-bold">{title} • <span className="text-xs lg:text-sm text-gray-500 font-normal">{post_human_date}</span></h1>
                </div>
                <p className="text-[0.6rem] sm:text-xs text-gray-500">Volunteering Hours: {volunteering_hours} - Est. Time: {est_time} - Application Deadline: {deadline} - {volunteer_amount} Volunteers Needed</p>
            </div>
        </div>
