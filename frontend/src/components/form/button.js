...
const Button = ({ className, text, action, isLoading, loaderClass, disabled }) => (
    <button value={"submit"} onClick={action} disabled={isLoading || disabled} className={`${className} ${isLoading && 'opacity-50'} bg-primary relative text-white font-semibold text-sm md:text-lg p-5 hover:shadow-xl hover:opacity-90 duration-150`}>
