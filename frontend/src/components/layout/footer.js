const Footer = () => (
    <div className="flex flex-col items-center p-10 space-y-8 shadow-xl shadow-slate-50 border-t border-gray-200">
        {/* <img src={logo} className="w-40 relative z-10" alt="logo" /> */}
        <h1 className="sm:text-4xl text-3xl font-bold z-10 relative">Logo</h1>
        <h1 className="sm:text-3xl text-base uppercase am:tracking-[0.4rem] tracking-[0.35rem] font-light sm:font-thin">Connect . Impact . Unite</h1>
